...
exports.create = asyncHandler(async (req, res) => {
  // Validate request
  if (!req.body.agentBIN || !req.body.agentName|| !req.body.agentEmail || !req.body.servicesOffered || !req.body.phoneNumber 
    || !req.body.agentAuthorizationLetter ) {
    res.status(400).send({
      message: ('agentBIN, agentName, agentEmail, servicesOffered and phoneNumber cannot be empty'),
    });
    return;
  }
